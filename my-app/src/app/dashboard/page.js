        ...
        <header className="flex items-center justify-between px-8 py-4 bg-white border-b border-slate-200 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative border-l border-slate-100 pl-4">
              <button 
                ...
                className="p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-colors relative flex items-center"
              >
              ...
              {showNotifications && (
                <div className="absolute left-0 mt-3 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 overflow-hidden">
                      ...
                      notifications.map((n, i) => (
                        <div key={i} className="p-4 border-b border-slate-50 hover:bg-slate-50">
                          <p className={`text-[9px] font-bold uppercase mb-1 ${
                            n.type === 'repair' ? 'text-orange-600' : 
                            n.type === 'customer' ? 'text-green-600' : 
                            n.type === 'stock' ? 'text-red-600' : 'text-blue-600'
                          }`}>{n.title}</p>
                          <p className="text-xs font-semibold text-slate-700">{n.desc}</p>
                        </div>
                      ))
                    ) : (
          ...
          <div className="hidden lg:flex items-center gap-2 bg-slate-50 p-1 rounded-2xl border border-slate-100">
            <button 
              ...
              className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-slate-600 hover:text-blue-600 hover:bg-white rounded-xl transition-all"
            >
              🛠️ New Repair
            </button>
